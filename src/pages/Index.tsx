...
const Index = () => {
  ...
  const players = [
    { id: 1, number: 71, name: 'Александр Овечкин', position: 'Нападающий', goals: 12, assists: 8 },
    { id: 2, number: 13, name: 'Павел Дацюк', position: 'Нападающий', goals: 8, assists: 15 },
    { id: 3, number: 8, name: 'Илья Ковальчук', position: 'Нападающий', goals: 10, assists: 11 },
    { id: 4, number: 1, name: 'Сергей Бобровский', position: 'Вратарь', goals: 0, assists: 0 },
  ];
